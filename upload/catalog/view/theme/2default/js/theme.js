...
(function ($) {
	...
	function showToast(message, type) {
		...
		var $toast = $(
			'<div class="toast toast-' + type + '" role="' + (type === 'danger' ? 'alert' : 'status') + '" aria-live="' + (type === 'danger' ? 'assertive' : 'polite') + '">' +
				'<svg class="toast-icon w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><use href="catalog/view/theme/2default/js/icons.svg#icon-' + TOAST_ICON[type] + '"></use></svg>' +
				'<span class="toast-message"></span>' +
				'<button type="button" class="toast-close" aria-label="Close">' +
					'<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><use href="catalog/view/theme/2default/js/icons.svg#icon-x"></use></svg>' +
				'</button>' +
			'</div>'
		);
	...
	function patchFontAwesomeIcons() {
		Object.keys(FA_TO_SVG).forEach(function (faClass) {
			$('i.fa.' + faClass).each(function () {
				$(this).replaceWith('<svg class="w-4 h-4 shrink-0 inline" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><use href="catalog/view/theme/2default/js/icons.svg#icon-' + FA_TO_SVG[faClass] + '"></use></svg>');
			});
		});
	}
	...
	function syncCartButton() {
		...
		$btn.html(
			'<svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><use href="catalog/view/theme/2default/js/icons.svg#icon-shopping-bag"></use></svg>' +
	...
	function syncWishlistButton() {
		...
		var count = match ? parseInt(match[0], 10) : 0;
		$btn.html(
			'<svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><use href="catalog/view/theme/2default/js/icons.svg#icon-heart"></use></svg>' +
